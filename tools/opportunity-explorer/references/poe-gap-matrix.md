...
Verified 2026-07-05 on the `hydrocortisone cream` niche (US, Svens Island,
German UI) — live side-by-side: UI screenshots in
`evidence/svens-island/opportunity-data/2026-07-05_poe_*.png`, native CSV
...
## EU verification (2026-07-05, Allmedica DE, `collagen pulver` niche)

- `--origin https://sellercentral.amazon.de --marketplace de`: search returned
  52 niches (names match the legacy sheko related-niches capture), full niche
