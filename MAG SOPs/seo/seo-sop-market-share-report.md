...
**Sample worksheet:** [Age of Sage - Market Share Report](https://docs.google.com/spreadsheets/d/<google-sheet-id>/copy)
...
Using the [template](https://docs.google.com/spreadsheets/d/<google-sheet-id>/copy), on the raw monthly data tab, arrange the search queries using the search query score from A to Z. Then, copy all the figures in the following columns and paste them onto the Summary sheet:
...
1. Make a copy of the template and save it to the client folder with the title format - ***Client Name - Market Share Report***
  ...
  - **Template:** [Market Share Report - Original V2 Final](https://docs.google.com/spreadsheets/d/<google-sheet-id>/copy)
