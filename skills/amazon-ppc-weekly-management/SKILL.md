...
- **Conquest SPCs**: one competitor per campaign, ASIN-exact targets, Down only, high ToS modifier; campaign creation goes through `amazon-sponsored-products-bulk-files` (bulk file, paused; AdLabs MCP cannot create campaigns).
