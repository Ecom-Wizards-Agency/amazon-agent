# Writing, building, branding and delivering the audit

Read this before writing a line. It is the whole output standard: narrative structure and voice,
the workbook, the figure set, the branded document, and delivery.
...
file up to first delivery and may re-render freely, and a human owns it after. Never re-render over
a delivered file. Corrections after delivery are edited into the Doc or Sheet instead, which keeps
