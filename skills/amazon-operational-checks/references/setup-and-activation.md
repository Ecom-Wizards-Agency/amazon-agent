...
Store teammate-specific configuration at `_local/amazon-operational-checks/config.json`. Never commit this file. Use these states:
...
4. Create or update `amazon-operational-checks-weekly` for Tuesday at 10:00 in the teammate timezone.
5. Create or update `amazon-operational-checks-monthly` for day 2 of each month at 11:00 in the teammate timezone.
