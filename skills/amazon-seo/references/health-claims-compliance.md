...
- Factual-compositional statements are reliably LOW: ingredient names/types, process descriptions (peptide size, hydrolysis), solubility, accurate free-from claims, origin/quality ("Made in Germany"). This is the compliant floor every listing can stand on, and it confirms the names-vs-effects core rule.
