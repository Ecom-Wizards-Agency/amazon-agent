...
- `{market_signals_state_path}`: local path of the precomputed Keepa market-signal state file. The check reads this file; it never fetches market signals itself.
