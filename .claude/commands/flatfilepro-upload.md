---
description: Upload/map an already-prepared FlatFilePro .xlsx in the logged-in Chrome session (SKU-matched, column-by-column; stop before final apply)
argument-hint: "[.xlsx path + target Seller & Marketplace, or 'continue from the open upload screen']"
---
