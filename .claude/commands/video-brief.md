...
8. **Campaign structure.** State the naming: one campaign per keyword, one ad group per angle (the batch) named `Angle N - <name>`. Stop there; campaign creation routes to amazon-campaign-builder.
