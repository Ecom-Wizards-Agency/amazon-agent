...
|---|---|---|
| Bids, placements, harvests, negatives, pacing, and staged applies | `skills/amazon-ppc-weekly-management/SKILL.md` | `_local/ads-strategy/strategy.json` |
| Interactive Ads Console work and non-SP routing | `skills/amazon-ads-console/SKILL.md` | Current Amazon help |
| New Sponsored Products campaign construction | `skills/amazon-sponsored-products-bulk-files/SKILL.md` | Per-run config plus local strategy |
| Read-only performance flags and briefs | `skills/amazon-ads-performance-briefs/SKILL.md` | Local strategy plus client goal/stage |
