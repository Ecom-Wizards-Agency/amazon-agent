...
| Ad/sales audit data pulls | `amazon-ad-audit` (`/amazon-audit`) | Mixed | SQP + Business Report via CDP report fetcher; ads bulk sheet via Ads console download | Workbook + narrative build is local. |
