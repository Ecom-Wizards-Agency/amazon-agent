...
This folder is the GitHub-synced workspace for newly created SOP drafts.

Use `sop-drafts/` when creating a new operational Amazon SOP that is not ready to be promoted into `MAG SOPs/` or another source library yet.
