...
source_url: "https://sellercentral.amazon.com/help/hub/reference/G1791"
...
A translation into Chinese is available for your ease of reference.  
...
Amazon will provide notice to you under this Agreement by posting changes to Seller Central or to the applicable Amazon Services site to which the changes relate (such as the Solution Provider Portal Site) accessible through your account), by sending you an email notification, or by similar means. You must send all notices and other communications relating to Amazon to our Selling Partner Support team via Seller Central, email, the Contact Us form, or similar means. We may also communicate with you electronically and in other media, and you consent to such communications. You may change your e-mail addresses and certain other information in Seller Central, as applicable. You will ensure that all of your information is up to date and accurate at all times.
...
If you deploy, enable, or authorize an Agent to access or interact with any Amazon Services, the following restrictions apply:

19.1 Identification and Compliance Requirements All Agents must clearly identify themselves as automated systems and comply with the requirements specified in the Agent Policy at all times when accessing Amazon Services. Agents are prohibited from accessing Amazon Services if Amazon has explicitly requested cessation of such access.

19.2 Access Limitations Amazon reserves the right, at its sole discretion, to limit or restrict Agent access to Amazon Services through technical or other measures.
...
The Elected Country is the United States: 
...
Amazon Payments, Inc., Amazon Capital Services, Inc., or Amazon.com Services LLC, according to the Transaction Processing Services Terms
...
"Amazon Site" means, as applicable, the CA Amazon Site, or the US Amazon Site.
...
"Excluded Products" means the items described on the applicable Restricted Products pages in Seller Central, any other applicable Program Policy, or any other information made available to you by Amazon.
...
Other amounts that for specific products categories that Amazon may require. 
...
S-3.2 A-to-z Guarantee, Claims Process, and Chargebacks. Claims that we receive or initiate under the "A-to-z Guarantee" or the “A-to-z Claims Process for Property Damage and Personal Injury” will be governed by the Program Policy for such claims. 
