...
source_url: "https://sellercentral.amazon.com/help/hub/reference/G27951"
...
Note: For information about A-to-z Guarantee claims covering property damage or personal injury caused by a defective product, go to A-to-z Claims Process for Property Damage and Personal Injury. For more information about fashion item-specific return policies, go to Free returns of fashion items for seller-fulfilled orders.
Important: The A-to-z Guarantee policy is different for Amazon Pay transactions. You can review the Amazon A-to-z Guarantee for Merchants on the Amazon Pay website.

Before a claim can be filed

Customers must first contact you and give you an opportunity to resolve their issue, except in certain situations identified in the Instant customer refunds section below, in order to become eligible to file an A-to-z Guarantee claim:
...
You then have to take the action described below to resolve the issue raised by the customer:
...
Item does not meet customer expectation: If the customer raises a return request, you must authorize or respond to that request within 48 hours with a valid domestic return address, a prepaid return label, or a returnless resolution. It's best practice to respond within 24 hours.
...
You authorized the return request with an international return address but failed to provide a prepaid return label or returnless resolution. You must either edit the return authorization and upload a prepaid return label with valid tracking, or issue a full refund within two days of receiving the return request.
...
Tracking shows that the package is returning to you: If the tracking shows that the item was undeliverable to the customer or refused, and we receive tracking information indicating that the package is returning to you, we will automatically refund the customer and debit your account for the claim amount. It does not impact your account health or order defect rate (ODR).
Tracking shows that you have not shipped the package when the customer files the claim with Amazon: If you have not shipped the package when the customer files the claim with Amazon, or you have not confirmed the shipment on Seller Central, we will automatically refund the customer and debit your account for the claim amount. This will impact your account health and order defect rate (ODR).
You closed your seller account on Amazon while you had existing orders to fulfill, or the customer experienced a delivery or product related issue with their order.
Your selling account was deactivated while you had existing orders to fulfill or the customer experienced a delivery or product related issue with their order. This will impact your account health and order defect rate (ODR).

Notification of claim submission

You'll receive email notification when a customer files a claim. You can also track claims filed by customers by navigating to the Manage A-to-z claims page in your seller account in the Performance menu. You are responsible for monitoring and resolving your claims.

Note: You can also use this quick link to monitor claims status by entering a claims related order ID.
Getting products back from customers
