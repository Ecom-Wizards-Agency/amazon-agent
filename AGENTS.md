...
- `amazon-ads`: Ads Console, PPC, bidding, budgets, targeting. Sponsored Products remain the core doctrine. Sponsored Brands, Sponsored Display, DSP, AMC, and Brand Store strategy are separate modules that require verified marketplace mechanics; never invent universal spend shares for them.
